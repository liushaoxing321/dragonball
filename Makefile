# Specify the gcc executable you will use the dragonball plugin with either here
...
# your path).  It is not necessary to install LLVM to build dragonball against
...
PLUGIN=dragonball.so
PLUGIN_OBJECTS=Aliasing.o Middleend.o Cache.o ConstantConversion.o Convert.o \
...
# The following target exists for the benefit of the dragonball maintainers, and
